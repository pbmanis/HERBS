...
class RegisteredObject(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None, obj_id=0, obj_name='', obj_type='merged probe', object_icon=None):
        ...
        # self.text_btn.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Ignored)
        ...
        link_icon.addPixmap(QtGui.QPixmap("icons/sidebar/link_off.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        link_icon.addPixmap(QtGui.QPixmap("icons/sidebar/link.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
...
class ObjectControl(QtCore.QObject):
    ...
    def __init__(self, parent=None):
        ...
        self.outer_frame.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
